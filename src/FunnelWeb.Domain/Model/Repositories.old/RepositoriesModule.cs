...
using FunnelWeb.Domain.Model.Mappings;
using FunnelWeb.Domain.Model.Repositories.Internal;
using FunnelWeb.Domain.Providers.Database;
using FunnelWeb.Domain.Providers.File;
using FunnelWeb.Domain.Repositories;
using NHibernate;
using NHibernate.Bytecode;

namespace FunnelWeb.Domain.Model.Repositories
{
                    ...
                    .Mappings(m =>
                                  {
                                      ...
                                      var extension = context.Resolve<IEnumerable<IScriptedExtension>>();
