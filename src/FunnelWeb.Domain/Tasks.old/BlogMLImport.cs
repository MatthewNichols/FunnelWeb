...
using BlogML;
using BlogML.Xml;
using FunnelWeb.Domain.Authentication;
using FunnelWeb.Domain.Interfaces;
using FunnelWeb.Domain.Model;
//using FunnelWeb.Domain.Repositories;
//using FunnelWeb.Domain.Repositories.Queries;
...
namespace FunnelWeb.Domain.Tasks
{
    public class BlogMLImportTask : ITask
    {
        ...
        public IEnumerable<ITaskStep> Execute(Dictionary<string, object> properties)
        {
