...
using FunnelWeb.DataAccess.Sql.DatabaseDeployer.Infrastructure;
...
namespace FunnelWeb.DataAccess.Sql.DatabaseDeployer
{
    ...
    public class ApplicationDatabase : IApplicationDatabase
    {
        ...
        public string[] GetExtensionExecutedScripts(Func<IDbConnection> connectionFactory, IScriptedExtension extension)
        {
            return CreateJournal(connectionFactory, extension.SourceIdentifier, connectionStringSettings.Schema).GetExecutedScripts();
        }

        public string[] GetExtensionRequiredScripts(Func<IDbConnection> connectionFactory, IScriptedExtension extension)
        {
        ...
        /// </returns>
        public DatabaseUpgradeResult[] PerformUpgrade(IEnumerable<IScriptedExtension> scriptedExtensions, IUpgradeLog log)
        {
